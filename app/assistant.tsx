...
// persisted-chat API. Covers both the mock initial list (plain numeric ids
// like "1", "2", ...) and the in-memory "New chat" entries generated by
// handleNewThread, which are prefixed with "local-".
